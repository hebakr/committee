    ...
    var membersCommitteeCtrl = function (committesApi2) {
        ...
        vm.$routerOnActivate = function (next, previous) {
            ...
            committesApi2.getViewModel({ id: id }, function (response) {
                vm.model = response;
                if (vm.model.committee.superInspectorEndDate)
                    vm.model.committee.superInspectorEndDate = new Date(vm.model.committee.superInspectorEndDate);
                if (vm.model.committee.superInspectorStartDate)
                    vm.model.committee.superInspectorStartDate = new Date(vm.model.committee.superInspectorStartDate);
                if (vm.model.committee.chiefEndDate)
                    vm.model.committee.chiefEndDate = new Date(vm.model.committee.chiefEndDate);
                if (vm.model.committee.chiefStartDate)
                    vm.model.committee.chiefStartDate = new Date(vm.model.committee.chiefStartDate);
            });
        ...
        vm.submit = function () {
            ...
            vm.model.committee.chief.jobId = vm.model.committee.chief.jobObj.id;
            //vm.model.committee.chief.schoolId = vm.model.committee.chief.school.id;

            vm.model.committee.superInspector.jobId = vm.model.committee.superInspector.jobObj.id;
